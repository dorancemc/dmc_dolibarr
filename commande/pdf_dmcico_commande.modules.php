...
/**
 *	\file       htdocs/core/modules/commande/doc/pdf_dmcico_commande.modules.php
 *	\ingroup    commande
 ...
 */
class pdf_dmcico_commande extends ModelePDFCommandes
{
    var $db;
    var $name;
    var $description;
...
//		return pdf_pagefoot($pdf,$outputlangs,'COMMANDE_FREE_TEXT',$this->emetteur,$this->marge_basse,$this->marge_gauche,$this->page_hauteur,$object,0,$hidefreetext);
		return pdf_pagefoot($pdf,$outputlangs,'COMMANDE_FREE_TEXT','',$this->marge_basse,$this->marge_gauche,$this->page_hauteur,$object,0,$hidefreetext);
	}
